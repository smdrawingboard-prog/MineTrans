      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-bold mb-4">
            <span className="text-amber-600">MineTrans</span> Certification
            Program
          </h2>
          <p className="text-xl text-slate-400 mb-8 max-w-2xl mx-auto">
            Master the art of mining insurance underwriting with our
            comprehensive certification course. Learn the 12-step Business
            Interruption methodology and become a certified mining insurance
            professional.
          </p>
          <Button
        ...
        <div className="bg-gradient-to-r from-amber-600/20 to-amber-600/10 border border-amber-600/30 rounded-lg p-12 text-center">
          ...
          <p className="text-slate-400 mb-6 max-w-2xl mx-auto">
            Join our community of certified mining insurance professionals.
            Complete the course, pass the final exam, and receive your digital
            certificate.
          </p>
          <Button
            onClick={() => (window.location.href = "/certification/auth")}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-slate-400">
                Most students complete the certification in 4-6 weeks, studying
                at their own pace.
              </p>
            </div>
            <div>
              ...
              <p className="text-slate-400">
                Yes, you can retake section quizzes and the final exam as many
                times as needed.
              </p>
            </div>
            <div>
              ...
              <p className="text-slate-400">
                You need to score 70% or higher on the final exam to receive
                your certificate.
              </p>
            </div>
            <div>
              ...
              <p className="text-slate-400">
                Certificates are issued digitally and can be downloaded as PDF
                with your name and score.
              </p>
            </div>
          </div>
        </div>
